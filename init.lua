...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        -- DONT DO THIS, formatting goes through ruff's built-in lsp server
        -- python = { 'ruff' },
        --
  ...
  { -- Highlight, edit, and navigate code
    ...
    branch = 'master', -- legacy API; `main` branch is the rewrite without nvim-treesitter.configs
    build = ':TSUpdate',
  ...
  require 'kickstart.plugins.neo-tree', -- learn to not use the file-tree
